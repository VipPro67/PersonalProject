...
public class CreateCourseApiValidatorTest
{
    ...
    {   
        ...
        var result = _validator.TestValidate(createCourseDto);
        // Assert
        result.ShouldHaveValidationErrorFor(s => s.CourseId).WithErrorMessage("Course ID is required");
    ...
    public void CreateCourseDtoValidator_FieldsExceed_FailValidation()
    {
        ...
        var result = _validator.TestValidate(createCourseDto);
        // Assert
        result.ShouldHaveValidationErrorFor(c=>c.CourseId).WithErrorMessage("Course ID should not exceed 10 characters");
